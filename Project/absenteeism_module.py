...
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            column_names = ['Date', 'Transportation Expense', 'Distance to Work', 'Age',
                           ...
                           'Pets', 'Absenteeism Time in Hours', 'RT_1', 'RT_2', 'RT_3', 'RT_4']
            df.columns = column_names

            # re-order the columns in df
            column_names_reordered = ['RT_1', 'RT_2', 'RT_3', 'RT_4', 'Date', 'Transportation Expense', 
            ...
            # re-order the columns in df
            column_names_upd = ['RT_1', 'RT_2', 'RT_3', 'RT_4', 'Month Value', 'Day of the Week',
